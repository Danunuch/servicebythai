            ...
            <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12">
                            <div class="book_date book_date-costom-i">
                              ...
                              <input name="Text" type="text" value="" required="" placeholder="Full Name">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-12">
                            <div class="book_date book_date-costom-i">
                              ...
                              <input name="Text" type="text" value="" required="" placeholder="E-mail">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-12">
                            <div class="book_date book_date-costom-i">
                              ...
                              <input name="Text" type="text" value="" required="" placeholder="Password">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-12">
                            <div class="book_date book_date-costom-i">
                              <i class="fas fa-unlock-alt"></i>
                              <input name="Text" type="text" value="" required="" placeholder="Confirm Password">
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            ...
                            <br>
                            <div class="clearfix"></div>
                            <a href="" class="btn btn-warning btn-lg text-brown">สมัครสมาชิก</a>
                            <a href="" class="btn btn-warning btn-lg text-brown">ล้างข้อมูล</a>
                            <div class="clearfix"></div>

                            <br>
                            <p><a href="login.php" title="ลืมรหัสผ่าน"> <span class="fas fa-sign-in-alt"></span>
                            เข้าสู่ระบบ </a> | <a href="forgot-password.php" title="ลืมรหัสผ่าน"> <span class="fas fa-question"></span> ลืมรหัสผ่าน</a></p>
              ...
              <div class="col-sm-6">
                ...
                <div class="login-form-box">
                  ...
                  <h4 class="">หรือ เข้าสู่ระบบด้วย</h4>
                  <br>
                  <div class="book-appointment">
                    <div class="book-form agileits-login">
                      <form action="#" method="post">
                        <div class="row">
                          <div class="col-md-12">
                            <a class="fb-box" href=""><i class="fab fa-facebook-f"></i> เข้าสู่ระบบด้วย Facebook</a>
                          </div>


                          <div class="col-md-12">
                            <a class="google-box" href=""><i class="fab fa-google"></i> เข้าสู่ระบบด้วย Gmail</a>
                          </div>
                          <div class="clearfix"></div>
                          <br>
                          <div class="col-md-12">
                            <p>เราจะไม่โพสต์ไปที่ Facebook หรือ Google+ โดยไม่ขออนุญาตคุณก่อน</p>
                          </div>
